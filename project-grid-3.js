...
function exitGridView() {
  ...
  // Remove added class from .full-image.desktop to restore its state
  const fullImageDesktop = document.querySelector('.full-image.desktop');
  if (fullImageDesktop) {
    fullImageDesktop.classList.remove('landscape', 'portrait');
  }
